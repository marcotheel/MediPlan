...
Data.saveIntakes(this.items);Data.saveMeds(this.meds);Dashboard.render();if(typeof Router!=="undefined")Router.refreshCurrent();UI.toast(m.name+" wurde bestätigt.");
},
reset(){Data.reset();this.load();Dashboard.render();if(typeof Router!=="undefined")Router.refreshCurrent();UI.toast("Testdaten wurden zurückgesetzt.")}
};